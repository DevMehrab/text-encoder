...
export const MainContent = () => {
  ...
  let outputMessage = state === "Text to Code" 
  ?
  <span className="p-1 bg-emerald-100 text-emerald-600 rounded">Your Invisible text is ready: ↓</span> 
  : 
  <span className="p-1 bg-emerald-100 text-emerald-600 rounded">Your Decoded text is ready: ↓</span>
    ...
    <>
      <div className="w-full xl:w-1/2 ">
        <nav className="w-full grid grid-cols-2 gap-2 mb-8">
          <Button state={state} setInput={setInput} setOutput={setOutput} setState={setState} text={'Text to Code'} />
          <Button state={state} setInput={setInput} setOutput={setOutput} setState={setState} text={'Code to Text'} />
        </nav>
